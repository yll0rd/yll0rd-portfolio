...
const ContactSection = ({ className = "" }: { className?: string }) => {
  ...
  return (
    <section id="contact" className={`border-t border-border py-12 ${className}`}>
      {/* Header */}
      <h2 className="editorial-title">Let’s get in touch.</h2>
      <p className="mb-[18px] leading-[1.8] text-muted-foreground">
        For a project, an opportunity, or a conversation.
      </p>

      <div className="animate-fade-in delay-300">
        <div className="p-5 sm:p-8 md:p-10 !pl-0 !pt-0">
          <Form {...form}>
